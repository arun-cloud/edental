...
// Variables
return [
  "creatorName" => "Machine Coders",
  "creatorUrl" => "https://machinecoders.com",
  "templateName" => "eDental",
  "templateSuffix" => "HIS",
  "templateVersion" => "2.0.0",
  "templateFree" => true,
  "templateDescription" => "Dental Electornic Health Record System",
  "templateKeyword" => "eDental, Dental, Health, Record, HIS, Laravel, PHP, Admin Template, Machine Coders",
  ...
  "ogTitle" => "Dental Electornic Health Record System",
