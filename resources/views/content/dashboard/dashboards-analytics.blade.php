    ...
    <div class="col-xxl-8 mb-6 order-0">
        <div class="card">
            <div class="d-flex align-items-start row">
                <div class="col-sm-7">
                    <div class="card-body">
                        <h5 class="card-title text-primary mb-3">Hi Dr.Mohammed! 🎉</h5>
                        <p class="mb-6">Seen 12 Consultations Today.<br />Check your your profile.</p>
            ...
            <div class="col-lg-6 col-md-12 col-6 mb-6">
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <h4 class="card-title mb-3">SAR 12,628</h4>
            ...
            <div class="col-lg-6 col-md-12 col-6 mb-6">
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <h4 class="card-title mb-3">SAR 4,679</h4>
            ...
            <div class="col-6 mb-6 payments">
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <h4 class="card-title mb-3">SAR 2,456</h4>
            ...
            <div class="col-6 mb-6 transactions">
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <h4 class="card-title mb-3">SAR 14,857</h4>
                    ...
                    <div class="tab-pane fade show active" id="navs-tabs-line-card-income" role="tabpanel">
                        <div class="d-flex mb-6">
                            ...
                            <div>
                                ...
                                <div class="d-flex align-items-center">
                                    <h6 class="mb-0 me-1">SAR 459.10</h6>
                        ...
                        <div class="d-flex align-items-center justify-content-center mt-6 gap-3">
                            ...
                            <div>
                                ...
                                <small>39k SAR less than last week</small>
                            </div>
                        </div>
                    </div>
                </div>
